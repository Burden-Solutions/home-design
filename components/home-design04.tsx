...
const BurdensHomepage = () => {
  ...
  return (
    <div className="min-h-screen">
      <NavBar />
      <section className="min-h-screen flex items-center pt-20" style={{ backgroundColor: '#1A2332' }}>
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-20 w-full">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <div className="mb-6 inline-block px-4 py-1.5 rounded-full" style={{ backgroundColor: '#404A5A' }}>
                <span className="text-xs font-semibold tracking-wide text-white">EXPERIENCE THE DIFFERENCE</span>
              </div>
              <h1 className="text-5xl md:text-6xl font-bold mb-8 text-white leading-tight" style={{ letterSpacing: '-0.02em' }}>
                <span className="text-balance">Excellence in Every Detail</span>
              </h1>
              <p className="text-lg text-white/80 mb-10 leading-relaxed">
                Trusted by 12,000+ customers across Victoria. With 15 premium locations and 60+ years of heritage, Burdens delivers unmatched quality and service.
              </p>
            ...
            <div className="h-96 rounded-3xl flex items-center justify-center relative overflow-hidden" style={{ backgroundColor: '#404A5A', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' }}>
              <div className="text-center text-white/60">
                <Award size={48} className="mx-auto mb-3" />
                <div className="text-sm font-semibold">Premium Showcase</div>
              </div>
            </div>
          </div>
        </div>
