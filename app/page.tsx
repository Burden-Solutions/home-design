...
const designs = [
  { id: 1, name: "Design One", component: HomeDesign01 },
  { id: 2, name: "Design Two", component: HomeDesign02 },
  { id: 3, name: "Design Three", component: HomeDesign03 },
  { id: 4, name: "Design Four", component: HomeDesign04 },
];
...
export default function Home() {
  ...
  const ActiveDesign = designs.find(d => d.id === selectedDesign)?.component || HomeDesign01;
